...
class Mol3dCT(Dataset):
    def __init__(self, root=".", size=None, use_pe=True, pe_k=5):
        root = Path(root)
        ...
        for i, mol in enumerate(suppl):
            ...
            y = torch.tensor([properties_df.iloc[i].homolumogap], dtype=torch.float32)
            self.data.append((x_0, x_1, x_2, icd01, icd02, icd12, adj00, adj11, adj22, y))
