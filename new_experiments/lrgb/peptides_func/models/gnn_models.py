...
class GCN(nn.Module):
    def __init__(self, in_channels, hidden_channels, num_conv_layers,
                 readout_hidden_dim, num_readout_layers, out_dim=1, dropout=0.0):
        super().__init__()
        ...
        self.readout = _make_mlp(hidden_channels, readout_hidden_dim, num_readout_layers, out_dim, dropout)
...
class GAT(nn.Module):
    def __init__(self, in_channels, hidden_channels, num_conv_layers, num_heads,
                 edge_dim=None, readout_hidden_dim=64, num_readout_layers=2,
        ...
        for _ in range(num_conv_layers - 1):
            self.convs.append(GATv2Conv(hidden_channels * num_heads, hidden_channels, heads=num_heads,
                                        edge_dim=edge_dim, concat=True, dropout=dropout))
        self.readout = _make_mlp(hidden_channels * num_heads, readout_hidden_dim, num_readout_layers, out_dim, dropout)
...
class GIN(nn.Module):
    def __init__(self, in_channels, hidden_channels, num_conv_layers,
                 mlp_hidden_dim=None, readout_hidden_dim=64, num_readout_layers=2,
                 out_dim=1, dropout=0.0):
        super().__init__()
        self.dropout = dropout
