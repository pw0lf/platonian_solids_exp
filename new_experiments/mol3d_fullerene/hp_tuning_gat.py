"""Small hyperparameter search for GAT on mol3d_fullerene (combined mol3d +
...
if __name__ == "__main__":
    ...
    mol3d_train_data, _ = load_mol3d_gnn(mol3d_hp_train, root=args.mol3d_datapath, load_edge_features=True)
    mol3d_val_data, _   = load_mol3d_gnn(mol3d_hp_val,   root=args.mol3d_datapath, load_edge_features=True)

    fullerene_all = load_fullerene_gnn(root=str(FULLERENE_ROOT), target="Gap", load_edge_features=True)
