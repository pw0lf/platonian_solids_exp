"""Small hyperparameter search for GAT on fullerene (chem_features="full").
See hp_tuning_gcn.py for the shared rationale."""
import argparse
import json
import sys
import time
...
def make_model(cfg):
    return GAT(
        ...
        num_heads=cfg["num_heads"], edge_dim=EDGE_DIM["full"],
    )
...
if __name__ == "__main__":
    ...
    all_c60 = load_gnn_data("c60", root=DATA_ROOT, target=args.target, chem_features="full", load_edge_features=True)
