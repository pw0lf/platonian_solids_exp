...
if __name__ == "__main__":
    ...
    parser.add_argument("--hp_file",        type=str,   default=None,
                        help="JSON from hp_tuning_ct.py (e.g. results/best_hp_ct.json). Values for "
    ...
    for run in range(3):
        ...
        model = make_model(args, train_dataset.rk0_dim, train_dataset.rk1_dim, train_dataset.rk2_dim).to(device)
        if run == 0:
